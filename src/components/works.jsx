                    ...
                    <div className="info-card-link-contain justify-between w-full h-full flex-[1_1_0%] flex flex-row">
                        ...
                        <IconContext.Provider value={{ color: "white", size:"90"}}>
                            <div className="info-card-link flex flex-row w-[30%] justify-between items-center">
                                {workDetails.web == "featured" ? <div className="featured-btn w-[250px] h-[100px] rounded-[50px] flex justify-center items-center border-8 border-white text-white text-[40px] bg-transparent">Featured</div> : 
                                <a href={"https://jsp.ng/"} target="_blank"></a>}

...
export default function Works(props) {
    ...
    return (
        ...
        <div  key={index}>
         ...
         <div className={`card-${workDetails.position} flex-[5_5_0%] ${props.theme == "light" ? `bg-[${workDetails.imageLight}]` : `bg-[${workDetails.imageDark}]`}  ${eval("toggleCard"+workDetails.id) ? "show" : ""}`} id="card-two" onClick={() => {eval("setToggleCard" + workDetails.id)(!eval("toggleCard"+workDetails.id))}}>
